...
<div id="wrap">
    <div id="header">
        ...
        <p class="menu"><a href="http://www.naver.com/">아로홈</a> | <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">아로 고객센터</a></p>
    </div>
    <div id="container">
        ...
        <div class="content">
            ...
            <p>관련 문의사항은 <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">아로 고객센터</a>에 알려주시면 친절하게 안내해 드리겠습니다.</p>
            <p>감사합니다.</p>
        </div>
        <form class="search" style="margin-top:50px;" name="search" action="http://search.naver.com/search.naver" method="get" onsubmit="emulAcceptCharset(this);" accept-charset="ks_c_5601-1987">
            ...
            <p class="sch_desc">아로 검색으로 원하시는 페이지를 찾으실 수 있습니다.</p>
        </form>
    </div>
<div id="footer">
<address>
